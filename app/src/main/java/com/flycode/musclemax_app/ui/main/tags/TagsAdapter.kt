...
class TagsAdapter(private val context: Context) : RecyclerView.Adapter<TagsAdapter.ViewHolder>() {

    val tagList: MutableList<Tag>
    var onTagDeletedListener: OnTagDeletedListener? = null
